...
var STR_ICONPATH = '../images/calendrier/';
...
<script language="JavaScript">
document.write(
'<td>'+(obj_caller&&obj_caller.year_scroll?'<a href="javascript:set_datetime('+dt_prev_year.valueOf()+')"><img src="image/prev_year.gif" width="16" height="16" border="0" alt="Ann&eacute;e pr&eacute;c&eacute;dente"></a> ':'')+'<a href="javascript:set_datetime('+dt_prev_month.valueOf()+')"><img src="image/prev.gif" width="16" height="16" border="0" alt="Mois pr&eacute;c&eacute;dent"></a></td>'+
'<td align="center" width="100%"><font color="#ffffff">'+ARR_MONTHS[dt_current.getMonth()]+' '+dt_current.getFullYear() + '</font></td>'+
'<td><a href="javascript:set_datetime('+dt_next_year.valueOf()+')"><img src="image/next_year.gif" width="16" height="16" border="0" alt="Ann&eacute;e prochaine"></a>'+(obj_caller && obj_caller.year_scroll?' <a href="javascript:set_datetime('+dt_next_month.valueOf()+')"><img src="image/next.gif" width="16" height="16" border="0" alt="Mois prochain"></a>':'')+'</td>'
);
</script>
</tr>
</table></td></tr>
